...
export const copy = {
  ...
  cleanListTitle: "Clean public address list",
  cleanListLabel: "Clean unique public addresses",
  cleanListCopy: "Copy address list",
  cleanListCopied: "Address list copied",
  columnLine: "Line",
